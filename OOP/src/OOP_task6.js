...
const Producer = /** @class */ (function Producer(minPossibleProduce, maxPossibleProduce) {
...
const Deliveryman = /** @class */ (function Deliveryman(maxPossibleBuy) {
...
const Customer = /** @class */ (function Customer(minNeeds, maxNeeds) {
...
const Statistic = /** @class */ (function Statistic() {
